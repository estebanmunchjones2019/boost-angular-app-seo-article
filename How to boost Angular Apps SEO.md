...
2. **Let’s use just one `<h1></h1>` tag in our app routes, and use meaningful headers**:

   Inside our `home.component.html`, we could change the `<h1></h1>` tag content like this, making the title more meaningful:  
